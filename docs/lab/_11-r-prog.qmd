...
top_secret <- read.csv("https://raw.githubusercontent.com/kbodwin/decodeR/refs/heads/master/Base_R/Secret_Code")$V1
...
4. Square every number. (Remember that (number)^(power) is how you raise a number to a power.)
...
Paste the message in the Canvas quiz for this assignment, and upload this file (save first!). 